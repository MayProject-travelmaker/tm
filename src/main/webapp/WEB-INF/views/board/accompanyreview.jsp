		...
		<div class="row">
			...
			<div class="col-lg-9">
				<div class="panel-body">
					<br> <br>
					<div class="panel-heading" id="12">✏ 동행 후기</div>
					<br>
					<div>
						...
						<div>
							...
							<ul class="pagination"  style="justify-content: center">
								<li class="page-item">
									<c:if test="${startPage > pageBlock}">
										<a class="page-link" 
										href="${root}/board/accompanyreview.do?pageNumber=${startPage-pageBlock}&searchType=${searchType}&keyword=${keyword}">◀</a>
									</c:if>
								</li>
								
								<c:forEach var="i" begin="${startPage}" end="${endPage}">
									<li class="page-item">
										<a class="page-link"href="${root}/board/accompanyreview.do?pageNumber=${i}&searchType=${searchType}&keyword=${keyword}">${i}</a>
									</li>
								</c:forEach>
							...
							<button class="btn btn-primary" type="button"
								onclick="location.href='write.do?boardCode=12'" style="float: right;">글작성</button>
					</div>
				</div>
			</div>
		</div>
