...
<html lang="kr">
    <head>
        ...
        <!-- Core theme JS-->
        <script src="${root}/resources/js/scripts.js?v=<%=System.currentTimeMillis() %>"></script>
...
<!-- 			       	<input type="button" value="✔" class="btn btn-light"> -->
			       	<button type="button" id="upd" class="btn btn-light" value="${diaryDto.diaryNo}">✔</button>
	       		</div>
	       		
	       		<br>
	       		<br>	       	
	       		<c:if test="${diaryDto.diaryNo!=null}">현재 등록되어 있는 파일은 ${diaryDto.imgName} 입니다.<br><br></c:if>
	       	...
	       	<div>       		
	       		...
	       		<textarea rows="10%" cols="100%" style="position: fixed; bottom: 144px; margin-left: 31%;" name="diContent" id="diContent">${diaryDto.diContent}</textarea>
	       		<input type="hidden" value="${diaryDto.diaryNo}" name="diaryNo">
	       	</div>
