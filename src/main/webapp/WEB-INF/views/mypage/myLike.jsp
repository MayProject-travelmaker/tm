							...
							<ul class="pagination"  style="justify-content: center">
								<li class="page-item">
									<c:if test="${startPage > pageBlock}">
											<a class="page-link" 
											href="${root}/mypage/myLike.do?pageNumber=${startPage-pageBlock}" style="text-decoration: none">◀</a>
									</c:if>
								</li>
								...
								<c:forEach var="i" begin="${startPage}" end="${endPage}">
										<li class="page-item">
											<a class="page-link"
											href="${root}/mypage/myLike.do?pageNumber=${i}" style="text-decoration: none">${i}</a>
										</li>
								</c:forEach>
