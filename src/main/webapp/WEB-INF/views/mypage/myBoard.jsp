		...
		<div class="row">
			<div class="col">
				<div class="panel-body">
					<br> <br>
					<div class="panel-heading" id="1">✍ 내가 쓴 글</div>
					<br>
					<div>
						<c:choose>
							...
							<ul class="pagination"  style="justify-content: center">
								<li class="page-item">
									<c:if test="${startPage > pageBlock}">
											<a class="page-link" 
											href="${root}/mypage/myBoard.do?pageNumber=${startPage-pageBlock}" style="text-decoration: none">◀</a>
									</c:if>
								</li>
								...
								<c:forEach var="i" begin="${startPage}" end="${endPage}">
										<li class="page-item">
											<a class="page-link"
											href="${root}/mypage/myBoard.do?pageNumber=${i}" style="text-decoration: none">${i}</a>
										</li>
								</c:forEach>
