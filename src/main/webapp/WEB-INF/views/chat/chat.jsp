   ...
   var webSocket = {
         ...
         receiveMessage: function(msgData){
            ...
            if(msgData.messageType == 'CHAT') {
               ...
               // 입력된 채팅 내역 저장
               // 채팅내역1 - 아이디: 채팅메시지
               var text = msgData.msg.replace(/(<([^>]+)>)/ig,""); // 채팅내역 html 태그 제거 (XSS공격 방지)
               // 채팅내역2 - 날짜
               ...
               $('#messageArea').append('<div class="msgData">' + text + '<span style="margin-left:10px; color: gray; font-size: 10px">'+ msgData.currentTime +'</span></div>');
